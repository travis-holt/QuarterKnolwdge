...
- **Vision statement:** Become the standing instrument a contact-centre team lead uses each
  ...
  and what training to assign Ã¢â‚¬â€ across every department they run.
- **Target audience:**
...
- **Key value proposition:** A lightweight, no-backend tool that converts a short scenario quiz
  ...
  auto-assigned training Ã¢â‚¬â€ in seconds, with no install or accounts.
- **Main user problems solved:**
  1. Knowledge assessment that tests **application, not recall**.
  2. No single vanity score Ã¢â‚¬â€ **per-domain** signal that's actually actionable.
...
> (`Pediatrics_SOP_Updated.pdf` Ã¢â‚¬â€ the *Aizer Health Pediatric Department* operational report; the
...
- Deliver a credible, self-contained **prototype to demo to management**. Ã¢Å“â€¦ Done.
- Derive domains/questions from the real SOP. Ã¢Å“â€¦ Done.
- Per-domain scoring Ã¢â€ â€™ Learning/Solid/Can-Teach levels with editable thresholds. Ã¢Å“â€¦ Done.
- Capability matrix (hero) with column gaps, can-teach roster, readiness tally. Ã¢Å“â€¦ Done.
- Analytics dashboards (team overview + per-navigator). Ã¢Å“â€¦ Done.
- Auto-assign training by weak point, with previewable mockup content. Ã¢Å“â€¦ Done.
- Department dimension (Pediatrics + 3 mockup departments). Ã¢Å“â€¦ Done.
- A persistent public deployment for showcasing. Ã¢Å“â€¦ Done (Railway).

### Mid-Term Goals
- Ã¢Å“â€¦ **Multi-department live checks:** Pediatrics and OB/GYN are now live checks. Adult Medicine
  and Behavioural Health remain mockups pending their SOPs.
- **Mentor pairing (floor-wide):** auto-match Learning Ã¢â€ â€ Can-Teach with balanced mentor load.
- **Coverage / bus-factor risk view:** flag domains with only 0Ã¢â‚¬â€œ1 teachers (single point of failure).
- **Training completion tracking:** Assigned Ã¢â€ â€™ In progress Ã¢â€ â€™ Done states (in-memory for the demo).

### Long-Term Vision
- A production tool with persistence, multiple SOPs/departments, historical trend (quarter over
  quarter), training ROI, and role-based access Ã¢â‚¬â€ the team lead's standing quarterly instrument.
...
1. **Take the check** Ã¢â‚¬â€ Start Ã¢â€ â€™ step through ~20 domain-tagged multiple-choice scenarios Ã¢â€ â€™ submit.
2. **See results** Ã¢â‚¬â€ per-domain % and level (Learning/Solid/Can-Teach); no single grade.
3. **Read the matrix** Ã¢â‚¬â€ sample navigators + the taker's new row, color-coded; with column gaps,
   can-teach roster, readiness tally.
4. **Explore analytics** Ã¢â‚¬â€ Team Overview (floor KPIs, distribution, cross-department strength) and
   per-navigator dashboards (strengths, growth areas, assigned training, suggested mentors).
5. **Manage training** Ã¢â‚¬â€ Training tab shows auto-assigned modules by domain cohort and by
   navigator; preview a module's mockup lesson content.
6. **Switch departments** Ã¢â‚¬â€ the department bar re-scopes the matrix/dashboards/training to
...
> Status legend: **Complete** Ã‚Â· **In Progress** Ã‚Â· **Planned** Ã‚Â· **Deprecated** Ã‚Â· **Removed**.

### F1 Ã¢â‚¬â€ Take-the-Check Flow
- **Purpose:** Assess application of SOP knowledge via scenario MCQs.
- **User benefit:** Fast, low-stakes, domain-tagged assessment.
- **Technical implementation:** [src/components/Check.jsx](src/components/Check.jsx) Ã¢â‚¬â€ stepped,
...
### F2 Ã¢â‚¬â€ Multi-Signal Scoring Ã¢â€ â€™ Level Mapping (two axes)
...
- **Notes:** `<60` Learning, `60Ã¢â‚¬â€œ84` Solid, `85+` Can-Teach (same bands for both axes). Each option
  carries `points` (0Ã¢â‚¬â€œ100) + an SOP-referenced `rationale`; the 100-point option is `correctOptionId`.

### F3 Ã¢â‚¬â€ Capability Matrix (hero screen)
- **Purpose:** Navigators Ãƒâ€” domains grid, color-coded by level; the centrepiece.
...
### F4 Ã¢â‚¬â€ Matrix Read-offs (column gaps Ã‚Â· can-teach roster Ã‚Â· readiness tally)
- **Purpose:** The "so what" Ã¢â‚¬â€ turn the grid into priorities.
...
### F5 Ã¢â‚¬â€ Team Overview Dashboard
...
### F6 Ã¢â‚¬â€ Navigators List + Per-Navigator Dashboard
...
- **Technical implementation:** [src/components/Navigators.jsx](src/components/Navigators.jsx) and
  [src/components/NavigatorDetail.jsx](src/components/NavigatorDetail.jsx) Ã¢â‚¬â€ strengths, growth
  areas, per-domain bars (worstÃ¢â€ â€™best), per-department strip, assigned training, suggested mentors.
- **Status:** Complete.
- **Dependencies:** F2, F8, F10, `departmentMatrix()`, `mentorSuggestions()`.

### F7 Ã¢â‚¬â€ Suggested Mentors (per navigator)
...
### F8 Ã¢â‚¬â€ Auto-Assigned Training
...
### F9 Ã¢â‚¬â€ Training Module Preview (mockup content)
...
### F10 Ã¢â‚¬â€ Department Dimension
...
- **Technical implementation:** [src/data/departments.js](src/data/departments.js) Ã¢â‚¬â€ now exports
  `ASSESSED_DEPTS = ['pediatrics', 'obgyn']`, `DEFAULT_DEPT`, `isAssessed(id)`, and a back-compat
  `ASSESSED_DEPT` alias. [src/data/questions-obgyn.js](src/data/questions-obgyn.js) Ã¢â‚¬â€ 14 sanitized
  ...
  can switch departments after without signing out via a nav pill (Ã¢â€¡â€ž) or by clicking assessed dept
  cards in the "Strength across departments" strip Ã¢â‚¬â€ clicking calls `handleDeptSelect(deptId)` which
  ...
  the correct SOP. **All OB/GYN content is sanitized** Ã¢â‚¬â€ generic role labels only, no real provider
...
### F11 Ã¢â‚¬â€ Deployment (Railway)
- **Purpose:** Persistent public URL + a place to run the Gemini proxy (which GitHub Pages can't).
- **Technical implementation:** `server.js` Ã¢â‚¬â€ Express 5 app that serves `dist/` as static SPA and
  mounts the `/api/*` handlers (same `(req, res)` signature as the Vercel originals; reads `PORT`
  from env, Railway injects it automatically). `railway.toml` Ã¢â‚¬â€ Railpack config (`buildCommand: npm
  run build`, `startCommand: npm start`, `nixpacksConfigPath: nixpacks.toml`). `nixpacks.toml` Ã¢â‚¬â€
...
### F12 Ã¢â‚¬â€ Competency Axis (9 competencies)
- **Purpose:** Measure *how* a navigator thinks/decides/communicates, across all domains.
- **User benefit:** Capability signal orthogonal to topic Ã¢â‚¬â€ surfaces e.g. weak Escalation even when
  domain scores look fine.
- **Technical implementation:** [src/data/competencies.js](src/data/competencies.js) (`COMPETENCIES`
  Ãƒâ€”9); `scorePerCompetency()` + `competencyDistribution()` in scoring.js; competency breakdown on
  `NavigatorDetail`, competency distribution on `Overview`. Stored as `results.competencyScores`.
- **Status:** Complete.

### F13 Ã¢â‚¬â€ Two-Layer Coaching (post-check)
- **Purpose:** Immediate, specific feedback after a check Ã¢â‚¬â€ rule-based baseline + optional AI layer.
- **User benefit:** The navigator leaves knowing exactly what to reinforce and why; AI layer adds
  personalized 2Ã¢â‚¬â€œ3 sentence coaching grounded in what they actually got wrong.
- **Technical implementation:** [src/components/Coaching.jsx](src/components/Coaching.jsx) Ã¢â‚¬â€ on mount,
  ...
  [api/generate-coaching.js](api/generate-coaching.js) Ã¢â‚¬â€ Gemini proxy (same key rotation as
  ...
  only Ã¢â‚¬â€ never touches a score or Firestore.
- **Status:** Complete (Phase 2 Ã¢â‚¬â€ first AI-in-the-live-path feature).

### F15 Ã¢â‚¬â€ AI Interview Simulation (roleplay + grading)
- **Purpose:** Let navigators practice handling a patient call before a real one Ã¢â‚¬â€ low-stakes,
...
- **User benefit:** Gemini acts as a patient caller; the navigator types responses exactly as they
  ...
  can discard sessions they don't want saved, or save and receive an AI score (0Ã¢â‚¬â€œ100) with specific
  strengths and improvements grounded in the SOP.
- **Technical implementation:**
  - [api/interview-turn.js](api/interview-turn.js) Ã¢â‚¬â€ two-mode Gemini proxy: **init** generates
    caller scenario + opening line; **turn** continues the call in character.
  - [api/grade-interview.js](api/grade-interview.js) Ã¢â‚¬â€ new grading endpoint. Takes the full
    ...
    clamped 0Ã¢â‚¬â€œ100 and validated before returning.
  - [src/components/Interview.jsx](src/components/Interview.jsx) Ã¢â‚¬â€ phases: `setup Ã¢â€ â€™ loading Ã¢â€ â€™
    active Ã¢â€ â€™ saving Ã¢â€ â€™ grading Ã¢â€ â€™ reviewed` (or `discarded` if navigator chooses not to save).
...
- **Notes:** Scores are advisory Ã¢â‚¬â€ they do not feed `scorePerDomain` or the capability matrix.
...
### F16 Ã¢â‚¬â€ "Spot the Error" QA Audit Assessment
- **Purpose:** A **scored** QA-audit assessment Ã¢â‚¬â€ navigators act as a QA auditor over AI-generated
...
- **User benefit:** A real, low-friction assessment of applied domain knowledge that moves the
  navigator's rating Ã¢â‚¬â€ finding others' mistakes tests SOP mastery more sharply than recall.
- **Two modes (both in `SpotTheError.jsx`, driven by `mode` + `domains` props):**
  - **`full`** Ã¢â‚¬â€ the Start-level alternative to MCQ: **one item per domain** across all 6 domains,
    producing a complete per-domain profile. Saved as the primary result (full replacement).
  - **`domain`** Ã¢â‚¬â€ the training-plan launch: `SPOT_ASSESSMENT_SIZE` (=5) items for **one** domain;
...
- **Technical implementation:**
  ...
  - `src/components/SpotTheError.jsx` Ã¢â‚¬â€ phases: `loading` (fires one `/api/generate-audit` call per
    planned item in parallel via `Promise.allSettled`, keeps whatever succeeds; full-mode domains
    that fail to generate backfill to 0) Ã¢â€ â€™ `active` (one item at a time; **one click per item**,
    then a correct/wrong reveal + Next; each item shows its domain tag) Ã¢â€ â€™ `review` (overall score +
    level badge, a per-domain breakdown in full mode, and a per-item list of the actual error + what
    the SOP says) Ã¢â€ â€™ `saving` Ã¢â€ â€™ `done`. No hints, no reflection, no AI coaching.
  - **Score feed:** `SpotTheError` calls `onComplete(domainScores, mode)`;
    `NavigatorApp.handleSpotComplete` saves the scores (full Ã¢â€ â€™ replace whole profile; domain Ã¢â€ â€™
  ...
  - **Coexistence:** MCQ and Spot results are stored in separate docs and both kept Ã¢â‚¬â€ a navigator
  ...
  - **Completion tracking (supervisor):** completions are department-scoped; `subscribeCompletions` in `SupervisorApp` filters to the selected department before it builds
    `completionMap: { [navigatorId]: Set<domainId> }`. "Ã¢Å“â€œ Practiced" badges appear in
...
- **Technical implementation:** New `resultHistory` Firestore collection (append-only snapshot on
  every `saveResult`). Pure functions in `scoring.js`: `buildTrend(history, { synthesize })` Ã¢â€ â€™
  per-domain and overall sparkline series (prepends `TREND_SYNTH_POINTS` illustrative leading points
  when real history < 2); `trainingImpact(history, completions, domainId)` Ã¢â€ â€™ before/after/delta;
  `teamTrend(allHistory)` Ã¢â€ â€™ floor solidPlusRate + avgReadiness per time bucket.
...
### F18 Ã¢â‚¬â€ Evidence-Based Competency Dossier
- **Purpose:** Per-navigator view tying each competency rating to the exact SOP scenarios they
  answered Ã¢â‚¬â€ what they chose, what was best, and the authored rationale.
- **User benefit:** Turns "you're Learning in Escalation" into a specific, coaching-ready evidence
  record Ã¢â‚¬â€ "here are the 4 questions that drove that rating and what you got wrong."
- **Technical implementation:** `buildDossier(row, answers, questions, interviews, completions)` in
  `scoring.js` Ã¢â€ â€™ `{ byCompetency, byDomain }`. Competency cards in `NavigatorDetail.jsx` are now
...
### F19 Ã¢â‚¬â€ Supervisor Action Center
...
- **Technical implementation:** `buildActionCenter(rows, { history, interviews, completions })` in
  `scoring.js` Ã¢â€ â€™ five category arrays. New `src/components/ActionCenter.jsx`. Supervisor tab
...
### F20 Ã¢â‚¬â€ Adaptive, AI-Personalized Development Paths
- **Purpose:** Per-domain 5-step development sequences (coaching Ã¢â€ â€™ practice Ã¢â€ â€™ interview Ã¢â€ â€™ module Ã¢â€ â€™ mini-check)
...
- **Technical implementation:**
  - `buildDevPath(row, completions, interviews)` in `scoring.js` Ã¢â€ â€™ per-domain `{ domainId, steps:
    [{kind, status}], percentComplete }`. Status derived from completions (by kind) + interview grades.
  - New `api/sequence-path.js` Ã¢â‚¬â€ Gemini proxy (temp 0.3, structured JSON, `validateSequenceResponse`
  ...
  - `src/components/MyTraining.jsx` rewritten: flat list Ã¢â€ â€™ path stepper per domain; "Personalize my
...
### F21 Ã¢â‚¬â€ Mentor Matching Engine (persisted pairings + outcomes)
- **Purpose:** Load-balanced mentor-mentee pairings with Firestore persistence and outcome delta tracking.
- **User benefit:** Supervisor sees suggested pairings (Learning/Solid mentees Ã¢â€ â€™ least-loaded Can-Teach
  mentors, capped at `MENTOR_MAX_LOAD`), assigns with one click, and tracks score improvement over time.
- **Technical implementation:**
  - `buildMentorMatches(rows, { maxLoad })` in `scoring.js` Ã¢â€ â€™ `{ pairings, load, unmatched }`.
    Learning mentees prioritized over Solid; least-loaded mentor first; unmatched when no teacher
    or mentor at cap.
  - `pairingOutcomes(savedPairings, rows)` Ã¢â€ â€™ enriches each pairing with `{ currentScore, delta, improved }`.
  ...
  - New `src/components/Mentorship.jsx`: suggested pairings grid (Assign button Ã¢â€ â€™ `savePairing`),
...
### F22 Ã¢â‚¬â€ Real-Time Voice Practice Call (Gemini Live API)
- **Purpose:** A genuine voice phone call with the AI patient Ã¢â‚¬â€ the caller speaks, the navigator
  speaks back, both in real time, no typing. Separate from the F15 text chat (the navigator picks
  voice **or** chat at the Practice entry Ã¢â‚¬â€ they're never mixed in one UI).
...
- **Why this design (vs the first attempt):** v1 bolted browser TTS + Web-Speech STT onto the chat
  UI. It felt glitchy Ã¢â‚¬â€ STT auto-sent on every pause (cutting the navigator off), the caller's text
...
- **Technical implementation:**
  - **Server relay Ã¢â‚¬â€ `api/live-relay.js`** (`attachLiveRelay(server)` in `server.js`): a `ws`
    `WebSocketServer` at **`/api/live`**. Browser Ã¢â€¡â€ž relay Ã¢â€¡â€ž Gemini Live
    ...
    Model: **`gemini-3.1-flash-live-preview`** Ã¢â‚¬â€ the gemini-3 Live model, verified to open a session
  ...
  - **Client Ã¢â‚¬â€ `src/components/VoiceCall.jsx`:** gets the scenario+callerName+opening line from the
    existing `/api/interview-turn` init, opens the relay socket, captures mic via
    `getUserMedia({echoCancellation,noiseSuppression,autoGainControl})` Ã¢â€ â€™ `ScriptProcessorNode`
    Ã¢â€ â€™ downsample to 16kHz PCM16 Ã¢â€ â€™ base64 Ã¢â€ â€™ relay. Caller audio (24kHz PCM16) is decoded into
    ...
    transcript fragments are whitespace-normalized before captions/grading. End call Ã¢â€ â€™ coalesced
    transcript Ã¢â€ â€™ `saveInterview` Ã¢â€ â€™ `/api/grade-interview` Ã¢â€ â€™ same reviewed screen as chat.
  - **Entry chooser:** `PracticeChooser` in `NavigatorApp.jsx` Ã¢â‚¬â€ the Practice tab shows two cards
    (Voice call / Text chat); `practiceMode` state routes to `<VoiceCall>` or `<Interview>` and
    resets when the navigator leaves the tab.
- **Status:** Complete. Server relay verified headlessly end-to-end (node client Ã¢â€ â€™ relay Ã¢â€ â€™ Gemini Ã¢â€ â€™
  caller audio + transcript). **In-browser mic capture/playback must be tested in Chrome/Edge** Ã¢â‚¬â€
...
### F23 Ã¢â‚¬â€ Adaptive Learning Feedback Loop
...
### F24 Ã¢â‚¬â€ SOP Manager (adder / builder / refiner)
- **Purpose:** Make department SOPs live, supervisor-managed data instead of hardcoded strings Ã¢â‚¬â€
...
- **User benefit:** Supervisors onboard a new department (Behavioral Health, Internal Medicine)
  or absorb a floor-rule change by pasting a document Ã¢â‚¬â€ no code deploy. The refiner flags every
  contradiction/outdated rule between new material and the current SOP (e.g. the BH psych-nurse Ã¢â€ â€™
  provider-direct routing change).
- **Technical implementation:**
  - **Firestore `sops` collection** Ã¢â‚¬â€ versioned docs `{ department, title, body, version,
  ...
  - **[api/_sop-store.js](api/_sop-store.js)** Ã¢â‚¬â€ server-side cached reader (firebase web SDK in
  ...
  - **`sopContextFor(deptId)` / `sopContextForFresh(deptId)` resolution order:** live active SOP Ã¢â€ â€™ hardcoded dept context Ã¢â€ â€™
    Pediatrics. Role context (`NAVIGATOR_ROLE_CONTEXT`) is always prepended.
  - **[api/refine-sop.js](api/refine-sop.js)** Ã¢â‚¬â€ `POST /api/refine-sop`, two modes (temp 0.2,
    JSON output, key rotation, exported pure validators `validateSopRefineResponse` /
    `validateSopFile` / `validateSopAudit` + 22 tests):
    **build** `{rawText|file, department}` Ã¢â€ â€™ `{sop:{title, body, notes[], audit}}` structures a
    raw document into the 6-domain SOP layout; **refine** `{rawText|file, currentSop,
    department}` Ã¢â€ â€™ `{sop:{title, body, changes:[{type: contradiction|outdated|addition|
    ...
    Ã¢â€°Â¤10 MB); `server.js` gives only `/api/refine-sop` the 20mb JSON body limit while other API
    ...
    inventions[] }` Ã¢â‚¬â€ source rules missing from the draft and draft statements not traceable to
    the source. Best-effort (null on failure, never blocks). Text inputs capped at 48k chars.
  - **[src/components/SopManager.jsx](src/components/SopManager.jsx)** Ã¢â‚¬â€ supervisor "SOPs" tab
    (dept-scoped via DeptBar, works for non-assessed depts too). Redesigned 2026-07-03:
    drag-and-drop **upload zone** (PDF Ã¢â€ â€™ base64 Ã¢â€ â€™ Gemini; TXT/MD read into the paste area; Word
    Ã¢â€ â€™ "export as PDF" hint), **active-version hero** (pulsing LIVE badge, meta chips: version /
    ...
    for drafts/archived), **fidelity chips + detail panels** on AI drafts (Ã¢Å“â€œ passed / Ã¢Å¡Â  N
    findings; omissions amber, inventions red Ã¢â‚¬â€ persisted on the draft doc via `saveSopDraft`'s
    new `notes`/`changes`/`audit` fields so they survive reload). Editing the ACTIVE version
    always saves a NEW draft version Ã¢â‚¬â€ active docs are never mutated.
- **Safety:** AI output is always a **draft** the supervisor reviews and activates Ã¢â‚¬â€ the endpoint
...
### F25 â€” Call QA Test (hard rubric-graded voice test)
- **Purpose:** Turn the voice practice call into a real, reliably-graded pass/fail test scored
  ...
  a scanned PDF â€” transcribed via Gemini native PDF input).
- **User benefit:** Navigators take a graded QA test call as the **final assessment phase**. They
  ...
  auto-fail alerts. Supervisors see a "QA TEST Â· PASS/FAIL" badge on the session in
...
- **Reliability design (the core of the feature):** the AI never produces a score.
  1. **Fixed binary rubric** ([api/_qa-rubric.js](api/_qa-rubric.js)): the guide's 100-point
     scorecard as structured data â€” 9 categories / 20 criteria (Opening 10 Â· Verification 10 Â·
     Call Control 10 Â· Doc Reason 10 Â· Communication 15 Â· Active Listening 10 Â· Knowledge 15 Â·
     Scheduling 15 Â· Closing 5) + 3 auto-fails (HIPAA/verification, clinical scope, conduct).
  ...
  2. **Gemini returns only verdicts** (`MET`/`NOT_MET`/`NA`) per criterion at **temperature 0**
     ...
     `POST /api/grade-call-qa`; scored output â†’ no lite-model fallback; one retry on malformed
     shape).
  3. **Deterministic trust gates + scoring in code** (`scoreQa`): MET without evidence that
     verifies against the transcript (normalized substring + single-turn word-set fallback) â†’
     NOT_MET; NA on a core (always-expected) criterion â†’ NOT_MET; auto-fail stands only with
     verified evidence (anti-hallucination), and zeroes the score. Score = earned/applicable
     points; **pass = â‰¥85 (`QA_PASS_THRESHOLD`) with zero auto-fails**. Same verdicts in â†’ same
     result out.
  ...
  4b. **Confidence / supervisor-review layer (2026-07-06, `assessQa`):** a deterministic
     ...
     of a confident verdict â€” the AI score is decision support, not the final word. Stored on
  ...
  5. **Transcript fairness layer (2026-07-03):** Gemini Live's transcription has no domain
     vocabulary, so it mis-hears SOP proper nouns ("Aizer Health" Ã¢â€ â€™ "Isr Pediatrics", provider /
     ...
     **before grading** Ã¢â‚¬â€ bounded to a curated glossary (explicit aliases + high-threshold
     ...
     vocabulary + abbreviation equivalences (PE = physical exam, TE = telephone encounter, Ã¢â‚¬Â¦) so a
     ...
     closing pleasantry criterion (`close-anything-thanks` reworded) Ã¢â‚¬â€ while verification, scope,
     routing, scheduling, and SOP-knowledge stay strict.
- **UI:** `VoiceCall.jsx` gains a `mode='practice'|'test'` prop â€” test mode has its own copy
...
### F14 Ã¢â‚¬â€ Question Bank + Gemini Scenario Generation (review gate)
...
- **Routing:** None (no React Router). Navigation is a `view` string inside each role app.
  Supervisor views: `overview Ã‚Â· matrix Ã‚Â· navigators Ã‚Â· navigator Ã‚Â· training Ã‚Â· module`. Navigator
  views: `check Ã‚Â· dashboard Ã‚Â· training Ã‚Â· module`. The Start **gate** (role select Ã¢â€ â€™ navigator
...
```
QuarterKnolwdge/
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ index.html               # Vite entry HTML
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ vite.config.js           # base '/' (served at root)
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ vercel.json              # Vercel config (kept; Railway is the active host)
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ railway.toml             # Railway/Railpack config (build + start + nixpacksConfigPath)
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ nixpacks.toml            # overrides npm ci Ã¢â€ â€™ npm install (avoids EBADPLATFORM)
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ server.js                # Express server: serves dist/ + mounts /api/* handlers
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ package.json             # scripts: dev/build/preview/test/test:watch/start; engines node>=20
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ README.md                # quick-start + tweak guide
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ CLAUDE.md                # THIS FILE Ã¢â‚¬â€ project knowledge base
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ SOP Guide.pdf            # source of truth for domains/questions
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ .env.local.example       # Firebase + Gemini env template (copy Ã¢â€ â€™ .env.local, gitignored)
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ firestore.rules          # pilot-grade Firestore security rules (roster/results/questions)
Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ api/                     # API handlers (originally Vercel serverless; now served by Express)
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ generate-scenarios.js#   Gemini proxy (holds GEMINI_API_KEY; validates output)
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ generate-coaching.js #   Gemini post-check coaching notes
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ interview-turn.js    #   Gemini roleplay (init + turn)
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ grade-interview.js   #   Gemini practice-call grading
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ generate-audit.js    #   Gemini "Spot the Error" transcript
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ coach-audit.js       #   Gemini audit-reflection coaching
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ sequence-path.js     #   Gemini dev-path step reordering
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ live-relay.js        #   WebSocket relay Ã¢â€ â€™ Gemini Live API (real-time voice call)
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ health.js            #   deploy/health check
Ã¢â€â€š   Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ _gemini-client.js    #   shared getApiKeys/callGemini/geminiWithRotation (helper, not a route)
Ã¢â€â€š   Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ _sop-context.js      #   SOP grounding text (helper, not a route)
Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ src/
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ main.jsx             # React root
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ App.jsx              # session + role routing (thin shell)
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ styles.css           # entire stylesheet
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ components/          # Nav, Start, Check, Coaching, Matrix, Overview, Navigators,
    Ã¢â€â€š                        #   NavigatorDetail, Training, MyTraining, TrainingModule,
    Ã¢â€â€š                        #   QuestionBank, QuestionEditor, DeptBar, SupervisorApp,
    Ã¢â€â€š                        #   NavigatorApp, EmptyState, Footer,
    Ã¢â€â€š                        #   Reveal + CountUp (presentation-layer motion primitives)
    Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ data/                # config, questions (DOMAINS + SEED_QUESTIONS), competencies,
    Ã¢â€â€š                        #   navigators (placeholder), training, departments
    Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ lib/
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ firebase.js      # Firebase app init + Firestore instance (defensive)
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ db.js            # ALL Firestore reads/writes (roster + results + questions)
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ session.js       # localStorage session layer (isolated, swappable for real auth)
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ useInView.js     # IntersectionObserver hook (scroll-reveal trigger)
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ useCountUp.js    # rAF count-up hook (reduced-motion aware)
        Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ scoring.js       # all scoring (2 axes), read-offs, analytics, training logic
        Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ scoring.test.js  # Vitest unit tests for scoring.js
```
...
- **Firebase / Firestore (pilot).** The app persists data to Cloud Firestore (free Spark tier).
  ...
  `archived`) Ã¢â‚¬â€ all UUID-keyed. All Firestore access is isolated in [src/lib/db.js](src/lib/db.js);
...
- **Express server + `/api` handlers.** [server.js](server.js) is the Railway entry point: an
  ...
  the same `(req, res)` Node.js signature they had as Vercel functions Ã¢â‚¬â€ no changes needed.
  ...
  `GENERATION_SECRET` Ã¢â‚¬â€ pilot-grade.
- **No auth system** (by design for the pilot): navigators pick their name from the roster and
  ...
  pilot-grade (open per-collection) Ã¢â‚¬â€ replace with real auth before production.
...
### Infrastructure
- **Hosting:** **Railway** Ã¢â‚¬â€ runs the Express server (`server.js`) which serves the Vite build
...
- **Deployment:** Railway (Git-connected to `main`). Railpack detects Node.js; `railway.toml`
  ...
  Env vars in Railway service Variables: `VITE_FIREBASE_*` (client, build-time Ã¢â‚¬â€ must be set
  BEFORE first build), `GEMINI_API_KEYS` + `GENERATION_SECRET` (server-only, never bundled).
  **Historical:** GitHub Pages (retired Ã¢â‚¬â€ no server) Ã¢â€ â€™ Vercel (owner chose Railway instead).
...
### 2026-06-23 Ã¢â‚¬â€ Use React + Vite (not single HTML file)
...
### 2026-06-23 Ã¢â‚¬â€ Derive all domains/questions from the SOP
...
### 2026-06-23 Ã¢â‚¬â€ Per-domain scoring, never a single total
...
### 2026-06-23 Ã¢â‚¬â€ Centralised tunable knobs in `config.js`
...
### 2026-06-23 Ã¢â‚¬â€ Store sample data as percentages (not pre-baked levels)
...
### 2026-06-23 Ã¢â‚¬â€ Knowledge-only analytics (no invented KPIs)
- **Decision:** Dropped the "knowledge Ã¢â€ â€™ performance (QA/CSAT/AHT)" correlation view.
...
### 2026-06-23 Ã¢â‚¬â€ Department dimension; Pediatrics live, others mockup
...
### 2026-06-24 Ã¢â‚¬â€ Firebase pilot: roster+PIN identity, UUID keys, role-split apps
...
### 2026-06-24 Ã¢â‚¬â€ Defensive Firebase init (never crash without config)
...
- **Reasoning:** Lets the full UI be built, tested, and committed *before* the owner creates the
  Firebase project Ã¢â‚¬â€ the app boots to a clean "not connected" state instead of a white-screen crash.
- **Impact:** Safe to commit now; safe to run locally; deploy is the only step that waits on config.

### 2026-06-23 Ã¢â‚¬â€ Deploy via `gh-pages` branch (not Actions)
...
### 2026-06-24 Ã¢â‚¬â€ Competency engine: 9 competencies as a second axis + points-based scoring
- **Decision:** Keep the 6 SOP domains AND add 9 competencies (capability axis), both derived from
  the same answers. Each option carries `points` (0Ã¢â‚¬â€œ100, partial credit) + an SOP `rationale`
...
- **Alternatives considered:** replace domains with competencies (loses topic signal); a separate
  4-level BeginnerÃ¢â€ â€™Expert scale (more config, inconsistent colours) Ã¢â‚¬â€ **[ASSUMPTION]** owner can opt
  into 4-level later.
- **Impact:** `scoring.js` functions take `questions` as a param; `results` gain `competencyScores`;
  new `Coaching` view + competency panels; tests grew 38 Ã¢â€ â€™ 46.

### 2026-06-24 Ã¢â‚¬â€ Live Gemini scenario generation via a serverless proxy
- **Decision:** SOPÃ¢â€ â€™scenario generation is a live in-app feature. A server-side function holds
  the Gemini key and returns validated drafts; the question bank moves to a Firestore
  `questions` collection with a supervisor **review gate** (draft Ã¢â€ â€™ active). Hosting migrates from
...
- **Alternatives considered:** offline one-off generation shipped as static data (less flexible);
  client-side Gemini calls (key exposure Ã¢â‚¬â€ rejected); Cloudflare Worker / Firebase Blaze (owner
  chose Railway).
...
### 2026-06-25 Ã¢â‚¬â€ Migrate hosting to Railway (Express server wrapping the /api handlers)
...
- **Reasoning:** Owner chose Railway. The `api/*` handlers use the standard Node.js `(req, res)`
  signature which Express accepts directly Ã¢â‚¬â€ no rewrite needed. Railway runs a persistent container
...
- **Impact:** New `server.js`, `railway.toml`, `nixpacks.toml`; `express` added as a dependency;
  ...
  `nixpacks.toml` overrides `npm ci` Ã¢â€ â€™ `npm install` to avoid `EBADPLATFORM` errors for
...
### 2026-06-30 Ã¢â‚¬â€ Voice practice call: Gemini Live API + WS relay, separate from chat
- **Decision:** Build the voice practice call on the **Gemini Live API** (real-time bidirectional
  ...
  (`VoiceCall.jsx`) Ã¢â‚¬â€ separate from the F15 text chat, chosen by the navigator at a Practice entry
  chooser.
- **Reasoning:** A first attempt bolted one-shot Gemini TTS + browser Web-Speech STT onto the chat
  ...
  voice. A relay is mandatory because the browser can't hold the Gemini key Ã¢â‚¬â€ the browser talks
  ...
  (the gemini-3 Live model) Ã¢â‚¬â€ picked via `listModels` over the `bidiGenerateContent` set after
...
- **Alternatives considered:** one-shot TTS + browser STT bolted onto chat (built first, rejected Ã¢â‚¬â€
  glitchy, wrong paradigm); browser `speechSynthesis` for caller voice (robotic, and still leaves
  the turn-taking problem); third-party realtime voice (ElevenLabs/Deepgram Ã¢â‚¬â€ new account, new
...
- **Impact:** New `api/live-relay.js` (`ws` WebSocketServer attached to the Express http server) +
  ...
  reliable, cross-browser, gradeable path. **Live API has its own preview quota** Ã¢â‚¬â€ fine for a
...
- **Department switching (navigator UX):** navigators can switch departments without signing out.
  A Ã¢â€¡â€ž pill in the nav bar (hidden mid-check) returns to the dept picker. Assessed dept cards in
  the "Strength across departments" strip are clickable buttons Ã¢â‚¬â€ clicking jumps directly to that
  dept's dashboard (if result exists) or check (if not). All assessed dept results are pre-fetched
  on mount so the strip shows real scores, not "Take the check Ã¢â€ â€™", for depts already completed.
- **Experimental / mockup:**
...
- **Client fetch layer:** `src/lib/apiFetch.js` Ã¢â‚¬â€ shared helper for all `/api` calls (AbortController
...
- **Server secret validation:** `api/_auth.js` Ã¢â‚¬â€ shared `validateSecret(req, res)` helper used by
...
- **Branding:** product name is **Knowledge Check** everywhere in the UI. `public/favicon.png`
  ...
  the 2026-06-28 commit Ã¢â‚¬â€ safe to delete in a future cleanup pass.
- **Known code quality items (non-blocking, from code review 2026-06-25):**
  - ~~Dead import `createRequire` in `server.js:6`~~ Ã¢â‚¬â€ **removed 2026-06-25**.
  - ~~`getApiKeys`/`callGemini`/`geminiWithRotation` duplicated across all `api/` handlers~~ Ã¢â‚¬â€
    **extracted to `api/_gemini-client.js` 2026-06-26** (REST Gemini handlers now import it).
  - ~~Redundant condition in `SpotTheError.jsx:157`~~ Ã¢â‚¬â€ **simplified 2026-06-26**.
  - ~~Interview score colours referenced undefined CSS vars (`--can-teach`/`--solid`/`--learning`)~~
    Ã¢â‚¬â€ **fixed 2026-06-26**: `--level-*` vars now defined in `:root`; colours come from
    `interviewScoreColor()` in `config.js`.
  - ~~`SUPERVISOR_PASSCODE` duplicated across 6 handlers~~ Ã¢â‚¬â€ **extracted to `api/_auth.js` 2026-06-26**.
  - ~~AbortController/fetch pattern duplicated across 4 client components~~ Ã¢â‚¬â€ **extracted to
    `src/lib/apiFetch.js` 2026-06-26**.
  - ~~Mixed `.then()` vs `async/await` in Coaching.jsx~~ Ã¢â‚¬â€ **standardised to `async/await` 2026-06-26**.
...
- **Deployment status:** **Railway** (Git-connected to `main`). Railway auto-deploys on push.
  ...
  needed Ã¢â‚¬â€ server falls back to `SUPERVISOR_PASSCODE`.
- **Question health:** active questions in the Question Bank now show a colored health dot once
  ...
  signal" if expert-level navigators are also failing Ã¢â‚¬â€ the Reverse QA feature. Raw `answers` are
  now stored on every new result doc; legacy docs (pre-this-change) are skipped silently.
- **Counts (today):** 6 domains (job-aligned 2026-07-02: intake Ã‚Â· classification Ã‚Â· routing Ã‚Â·
  scheduling Ã‚Â· boundaries Ã‚Â· documentation) Ã‚Â· 9 competencies Ã‚Â· 21 Pediatrics + 16
  OB/GYN = **37** seed questions (bank grows in Firestore per dept) Ã‚Â· 4 departments (**Pediatrics
  + OB/GYN live**, 2 mockup) Ã‚Â· **381** unit tests (15 test files) Ã‚Â· **11** Firestore collections
  (`roster`, `results`, `resultHistory`, `questions`, `audits`, `interviews`, `completions`,
  `pairings`, `supervisorFeedback`, `learningProposals`, `sops`) Ã‚Â·
  **10** REST serverless functions (`generate-scenarios`, `generate-coaching`, `interview-turn`,
  ...
  `refine-sop`, `health`) +
  **1** WebSocket relay (`live-relay.js` Ã¢â€ â€™ `/api/live`) Ã‚Â· **5** shared API helpers
  (`api/_gemini-client.js`, `api/_auth.js`, `api/_sop-store.js`, `api/_qa-rubric.js`,
  `api/_qa-glossary.js`) Ã‚Â· **1** shared client fetch helper (`src/lib/apiFetch.js`).
...
- **[src/App.jsx](src/App.jsx)** Ã¢â‚¬â€ thin session router only. Reads `getSession()` on mount;
...
- **[src/data/questions.js](src/data/questions.js):** `DOMAINS` (`{id,name,blurb}` Ã¢â‚¬â€ since
...
- **[src/data/competencies.js](src/data/competencies.js):** `COMPETENCIES` (9 Ãƒâ€” `{id,name,blurb}`),
  `competencyName(id)`, `COMPETENCY_IDS` (Set, for validating tags).
- **[src/data/navigators.js](src/data/navigators.js):** placeholder only Ã¢â‚¬â€ `SAMPLE_NAVIGATORS`
...
- **Firestore collections** (UUID-keyed; levels never stored Ã¢â‚¬â€ always derived client-side):
  - `roster/{uuid}` Ã¢â€ â€™ `{ name, pin, createdAt }` Ã¢â‚¬â€ navigator list; blank `pin` means the navigator
    creates it on first sign-in.
  - `results/{key}` Ã¢â€ â€™ `{ name, navigatorId, department, assessmentType, scores:{domainId:pct},
  ...
  - `questions/{uuid}` Ã¢â€ â€™ the question shape above. Only `status:'active'` appears in the check.
  - `supervisorFeedback/{uuid}` Ã¢â€ â€™ `{ targetType, targetId, status, note, context, createdAt }`.
    Status is one of `helpful`, `inaccurate`, `needsAdjustment`, `approved`, `rejected`.
  - `learningProposals/{uuid}` Ã¢â€ â€™ `{ type, title, target, payload, reasons, status, createdAt,
...
- **WebSocket endpoint:**
  - `WS /api/live` Ã¢â‚¬â€ real-time voice practice call relay (F22). Client sends `{type:'start',
...
- **Env vars:** client (gitignored `.env.local`, build-time) `VITE_FIREBASE_*`; **server-only**
  (Railway service Variables Ã¢â‚¬â€ never `VITE_`-prefixed) `GEMINI_API_KEYS` (comma-separated; rotated on
  rate-limit) or single `GEMINI_API_KEY`. `GENERATION_SECRET` is optional Ã¢â‚¬â€ server falls back to
...
# deploy: push to main Ã¢â€ â€™ Railway auto-deploys. Set env vars in Railway service Variables.
...
- **Design tone:** premium "refined-light" Ã¢â‚¬â€ calm, professional, credible, but visibly polished
  (Stripe/Notion/Attio register). Elevated from the original flat look on 2026-06-25 (see Ã‚Â§7) while
...
- **Palette (core in `config.js` `PALETTE`; full token set in `styles.css` `:root`):**
  ...
  - **Depth system:** elevation scale (`--shadow-xsÃ¢â‚¬Â¦lg`, `--shadow-glow`), focus `--ring`, glass
...
- **Level colors (traffic-light, `LEVELS`):** Learning red `#c0392b`, Solid amber `#e0b13c`,
  Can-Teach green `#3e8e5a` (unchanged Ã¢â‚¬â€ priority/level encoding kept off the brand gradient).
...
- **Component/style system:** single [src/styles.css](src/styles.css) (~2.2k lines), BEM-ish class
  names (`.matrix__cell`, `.kpi__value`, `.deptbar__pill`, Ã¢â‚¬Â¦), CSS variables, responsive grids.
...
- **Key user flows:** see [Ã‚Â§3](#3-product-usage) and the view diagram in [Ã‚Â§5](#5-architecture-overview).
- **Navigation:** top `Nav` tabs (Overview Ã‚Â· Take the check Ã‚Â· Matrix Ã‚Â· Navigators Ã‚Â· Training) +
...
- Training **completion tracking** Ã¢Å“â€¦ done (F16 "Spot the Error" closes this item with Firestore-persisted completions + supervisor checkmarks).

### Next Priority
- **Mentor pairing (floor-wide):** load-balanced Learning Ã¢â€ â€ Can-Teach matches.
- **Coverage / bus-factor:** flag domains with 0Ã¢â‚¬â€œ1 teachers (single point of failure).
...
- **Vite 5.4.21 carries known moderate advisories** (`server.fs.deny` bypass on Windows, optimized-deps
  ...
  Vite 8 (+ plugin-react major) â€” deliberately deferred from the 2026-07-06 stability pass; these are
  dev-server-side issues, not production-bundle issues, so risk in deployment is low.
- ~~Components, role apps, and API handlers untested~~ Ã¢â‚¬â€ **resolved 2026-06-26**: component tests
  (jsdom + Testing Library), API handler pure-function tests, and db.js mocked tests all added.
- ~~`getApiKeys`/`callGemini`/`geminiWithRotation` duplicated 6Ãƒâ€”~~ Ã¢â‚¬â€ **extracted to
  `api/_gemini-client.js` 2026-06-26**; REST Gemini handlers import it.
- ~~**Dead import:** `createRequire` imported in `server.js:6`~~ Ã¢â‚¬â€ removed 2026-06-25.
- ~~**Redundant condition** in `SpotTheError.jsx:157`~~ Ã¢â‚¬â€ simplified 2026-06-26.
- ~~`SUPERVISOR_PASSCODE` secret validation duplicated 6Ãƒâ€”~~ Ã¢â‚¬â€ **extracted to `api/_auth.js` 2026-06-26**.
- ~~AbortController/fetch pattern duplicated 4Ãƒâ€”~~ Ã¢â‚¬â€ **extracted to `src/lib/apiFetch.js` 2026-06-26**.
- No CI/CD (manual deploys via Railway push). A GitHub Actions step running `npm test` on PR
  would catch regressions.
- Single large `styles.css` Ã¢â‚¬â€ fine for now; revisit if it keeps growing.
- Repo name typo `QuarterKnolwdge` is in the Railway/GitHub remote URL Ã¢â‚¬â€ don't rename without
...
- **Resolve contradictory requirements explicitly.** "Knowledge Ã¢â€ â€™ performance link" vs
...
- **Railway defaults to Node 18; modern tooling needs 20+.** vitest@4 and vite@8 both require
  Node 20+. Set `"engines": {"node":">=20.0.0"}` in `package.json` Ã¢â‚¬â€ Nixpacks/Railpack reads it.
- **`npm ci` and cross-platform lockfiles don't mix.** When a lockfile is generated on one OS/CPU,
  ...
  to `npm install` via `nixpacks.toml` Ã¢â‚¬â€ it skips incompatible optional packages gracefully.
...
- **Express 5 requires named wildcards.** A bare `*` in `app.get('*', Ã¢â‚¬Â¦)` crashes at startup
...
- **In-repo harness (`.claude/`):** this repo carries a tailored **SAFe Agentic Workflow** harness
  (commands, agents, skills) Ã¢â‚¬â€ see the 2026-06-29 Ã‚Â§7 entry and
  ...
  **Branch ceremony removed 2026-06-30** Ã¢â‚¬â€ this is a solo, auto-deploy, no-CI project, so work is
...
- **Common pitfalls:**
  - **Never** `VITE_`-prefix `GEMINI_API_KEYS` Ã¢â‚¬â€ that would bundle the keys into the public client.
    They are server-only env vars used by `/api`.
  - The `/api` routes only run under `npm start` (Express) or on Railway Ã¢â‚¬â€ plain `npm run dev`
    (Vite only) won't serve them. To test Generate locally: `npm run build && npm start`.
  - Scoring takes the active `questions` bank as a param Ã¢â‚¬â€ don't re-import a static list inside the
  ...
  - Don't invent operational KPIs Ã¢â‚¬â€ the product is **knowledge-only** by decision.
...
- **Required workflows:**
  1. Make the change. 2. `npm test` (green) **and** `npm run build` (clean); `node --check` any
     edited `api/*`. 3. Update **this CLAUDE.md** (relevant section + a Ã‚Â§7 history entry). 4. Commit
...
- **Important assumptions:** Firebase pilot is live. Gemini generation is code-complete; `GEMINI_API_KEYS`
  is set in Railway Variables Ã¢â‚¬â€ generation should be live after the next deploy. `GENERATION_SECRET`
...
2. **Role-app integration tests** Ã¢â‚¬â€ the only remaining coverage gap. `SupervisorApp`, `NavigatorApp`,
...
- **Question bank regeneration** Ã¢â‚¬â€ the reset bank holds only the 37 seeds; supervisors should
  generate + activate additional scenarios per new domain via the Question Bank UI (the
  generation prompt now enforces distractor quality Ã¢â‚¬â€ regenerating also addresses the
  "too obvious" pilot feedback).
- **SOP content** Ã¢â‚¬â€ paste the real Pediatrics / OB/GYN SOPs (and later Behavioral Health /
  ...
  names (not in the public repo), but rules are pilot-grade Ã¢â‚¬â€ treat PII accordingly until real
  auth lands.

**Blockers:**
- Adult Medicine and Behavioural Health remain mockup Ã¢â‚¬â€ each needs an owner-provided SOP before
  they can become live checks.
- Real training materials needed to replace mockup module content.

**Upcoming milestones:**
- Ã¢Å“â€¦ First automated tests for `scoring.js` Ã¢â‚¬â€ done 2026-06-23 (Vitest, now 46 tests).
- Ã¢Å“â€¦ Firebase pilot implemented + deployed live Ã¢â‚¬â€ done 2026-06-24.
- Ã¢Å“â€¦ Competency engine + Gemini scenario generation (code) Ã¢â‚¬â€ done 2026-06-24.
- Ã¢Å“â€¦ Railway deployment: Express server + build fixes Ã¢â‚¬â€ done 2026-06-25.
- Ã¢Å“â€¦ Full SOP context + GENERATION_SECRET removed Ã¢â‚¬â€ done 2026-06-25.
- Ã¢Å“â€¦ Generative AI coaching (Phase 2, first feature) Ã¢â‚¬â€ done 2026-06-25.
- Ã¢Å“â€¦ AI interview simulation (roleplay phase) Ã¢â‚¬â€ done 2026-06-25.
- Ã¢Å“â€¦ "Spot the Error" QA audit training + completion tracking (F16) Ã¢â‚¬â€ done 2026-06-25.
- Ã¢Å“â€¦ SOP replaced with Pediatrics_SOP_Updated.pdf Ã¢â‚¬â€ done 2026-06-25.
- Ã¢Å“â€¦ Interview caller consistency fix Ã¢â‚¬â€ done 2026-06-25.
- Ã¢Å“â€¦ Interview discard option + AI grading after save (F15 Phase 2) Ã¢â‚¬â€ done 2026-06-25.
- Ã¢Å“â€¦ Craft pass: shared `api/_gemini-client.js` + latent CSS-var fix Ã¢â‚¬â€ done 2026-06-26.
- Ã¢Å“â€¦ OB/GYN live check (multi-department) Ã¢â‚¬â€ done 2026-06-26.
- Ã¢Å“â€¦ Question Health / SOP Drift flags Ã¢â‚¬â€ done 2026-06-26 (60 tests).
- Ã¢Å“â€¦ Navigator department switching UX Ã¢â‚¬â€ done 2026-06-26 (nav pill + clickable dept cards + all-dept pre-fetch).
- Ã¢Å“â€¦ Code-audit pass: DRY cleanup + test coverage expansion Ã¢â‚¬â€ done 2026-06-26 (130 tests, 5 test files,
  `apiFetch` helper, `_auth.js` helper, Vite v5.4.21 CVE patch, `scorePerDomain/scorePerCompetency`
  default-args defensive fix).
- Ã¢Å“â€¦ F17Ã¢â‚¬â€œF21: longitudinal trends, dossier, action center, adaptive dev paths, mentor matching Ã¢â‚¬â€ done
  2026-06-29 (206 tests, 8 test files, new `sequence-path` endpoint, `resultHistory` + `pairings` collections).
- Ã¢Å“â€¦ Contract-fix pass: sequence auth, dev-path interview wiring, action-center fields, mini-check
  evidence preservation, README/current-doc cleanup Ã¢â‚¬â€ done 2026-06-30 (208 tests, 8 test files).
- Role-app integration tests (`SupervisorApp`, `NavigatorApp`, `App`) Ã¢â‚¬â€ next coverage priority.
- Supervisor grade override for practice sessions Ã¢â‚¬â€ next interview feature.
